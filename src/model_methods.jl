...
# ╔═╡ b72bc6b3-6895-47df-b7bb-87ebfdd77267
begin
...
# ╔═╡ ba915ba8-9078-11f0-3f58-5f0f48e7a30f
md"""
Notebook to look at building up PINN for richards equation
"""

# ╔═╡ 9cbb782a-b2b3-4d91-ae0f-ef4b2be074f9
# soil parameters
θr, θs, α, n, m, K_sat =0.078, 0.43, 3.6, 1.56, 0.359, 2.9e-5;

# ╔═╡ fe3a9ed8-b19a-4187-9c16-a68aa9575980
md"""
Diffusion with gravity
"""

# ╔═╡ c27ecd6a-3a73-4f94-b7f7-ad765282518e
# begin
# 	@parameters z t
# 	@variables θ(..)
# 	Dz = Differential(z)
...
# ╔═╡ e6185736-ee08-4c4b-a019-0adc592a03a4
md"""
Simple Hydraulic conductivity 
"""

# ╔═╡ 08083ff2-359c-4897-ab2b-ceca0531269e
begin
	@parameters z t
	@variables θ(..)
	Dz = Differential(z)
...
# ╔═╡ a45c0633-3028-4a8c-8f93-542b896c1fcb
begin
		z_grid = 0.0:0.01:1.0
		t_grid = 0.0:50.0:3600.0
		u_predict = [first(phi([z, t], res.u)) for z in z_grid, t in t_grid]
...
manifest_format = "2.0"
project_hash = "0fed6f4541a3f0232fa6c34d7356e34aa59b01c9"
...
git-tree-sha1 = "d56ebebdaf6066c93f8e9f36d0ab50f2b24d1014"
...
git-tree-sha1 = "a001bbb71b857049c7c3d1aa3aa7b48ec6b16ead"
...
git-tree-sha1 = "7bee3e111944c2d5005907c83f93dc69edadb752"
...
[[deps.NeuralOperators]]
deps = ["ArgCheck", "ChainRulesCore", "ConcreteStructs", "FFTW", "Lux", "LuxCore", "LuxLib", "MLDataDevices", "NNlib", "Random", "Static", "WeightInitializers"]
git-tree-sha1 = "04644880fa80a3151bce9ba59d75eefdfef9d42d"
uuid = "ea5c82af-86e5-48da-8ee1-382d6ad7af4b"
version = "0.5.3"

[[deps.NeuralPDE]]
deps = ["ADTypes", "Adapt", "AdvancedHMC", "ArrayInterface", "ChainRulesCore", "ComponentArrays", "ConcreteStructs", "Cubature", "Distributions", "DocStringExtensions", "DomainSets", "ForwardDiff", "Functors", "Integrals", "IntervalSets", "LinearAlgebra", "LogDensityProblems", "Lux", "LuxCore", "MCMCChains", "MLDataDevices", "ModelingToolkit", "MonteCarloMeasurements", "NeuralOperators", "Optimisers", "Optimization", "OptimizationOptimisers", "Printf", "QuasiMonteCarlo", "Random", "RecursiveArrayTools", "Reexport", "RuntimeGeneratedFunctions", "SciMLBase", "Statistics", "SymbolicIndexingInterface", "SymbolicUtils", "Symbolics", "WeightInitializers", "Zygote"]
git-tree-sha1 = "6713c23c8a2bdaaf9e1459e06ced7901b8285ced"
...
git-tree-sha1 = "06d5ec14933d0e6f62a3709ef30a7a251daf7a22"
